...
interface SolutionFormSectionProps {
  ...
  onArrayInputChange: (field: 'challenges' | 'outcomes' | 'attachments', value: string, section: 'solution') => void;
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) => onArrayInputChange('attachments', e.target.value, 'solution')}
            className="w-full px-3 py-2 border-2 border-gray-300 bg-white text-gray-900 focus:border-gray-900 h-24"
