...
export default function ManageTechnologies() {
  ...
  const [createData, setCreateData] = useState<CreateTechnologyData>({
    name: '',
    description: '',
    iconUrl: '',
    color: '#000000',
    ...
    <div className="space-y-8">
      ...
      {showCreateForm && (
        <form onSubmit={handleCreate} className="bg-gray-50 p-6 border-2 border-gray-300 space-y-4">
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2">TECHNOLOGY NAME *</label>
            <input
              type="text"
        ...
        {technologies.length === 0 ? (
          ...
          <div className="grid gap-4">
            {technologies.map((technology) => (
              <div key={technology.id} className="bg-white p-6 border-2 border-gray-300 flex justify-between items-center">
