...
interface TagFormProps {
  initialData?: TagData;
  isEditing?: boolean;
  onSubmit: (tagData: TagData) => Promise<void>;
    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-600">
          {isEditing ? 'Update tag information' : 'Create a new tag for categorizing solutions'}
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white p-6 border-2 border-gray-300 space-y-4">
          <h3 className="text-xl font-bold text-gray-900 mb-4">TAG INFORMATION</h3>
